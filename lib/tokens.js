...
export const services = [
  {
    ...
    wpSource: "/deploiement-dinfrastructure-reseau",
    featured: true,
  },
  {
    slug: "protection",
  ...
  },
  {
    ...
    href: "/services/telephonie-ip",
    wpSource: "/telephonie-ip",
    featured: true,
  },
  {
    ...
    points: [],
    image: null,
    href: "/services/vente-installation",
    wpSource: "/vente-installation",
    featured: true,
  },
  {
    slug: "maintenance",
    ...
    wpSource: "/maintenance-casablanca",
    featured: true,
  },
  {
    slug: "audit-conseil",
    ...
    // ⚠️ Aucune page dédiée sur technovation.ma : le seul texte disponible est
    // la ligne ci-dessus, citée sur « À propos de nous ». Descriptif à fournir.
    wpSource: null,
    featured: false,
  },
];
