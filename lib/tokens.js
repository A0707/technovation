...
// Menu principal — structure complète du thème de référence.
// `pending: true` = rubrique prévue par la maquette dont la page n'existe pas
// encore côté WordPress. L'entrée reste visible (emplacement réservé) mais
// n'est pas cliquable, pour ne pas envoyer le visiteur sur une 404.
export const nav = [
  { label: "Accueil", href: "/" },
  ...
  { label: "Réalisations", href: null, pending: "Page à créer" },
  { label: "Blog", href: "https://technovation.ma/blog/", pending: "Aucun article publié" },
